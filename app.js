...
function addSkill(){
    ...
    if(skill_count<5)
    {
        ...
        `<div class="mb-3">
            ...
            <input maxlength = "50"  minlength="4" type="text" class="form-control" name="skill${skill_count}">
...
function addEducation(){
    ...
    if(education_count<3)
    {
        ...
        `<div class="mb-3">
            ...
            <input type="text" name="institute${education_count}" class="form-control "maxlength = "50"  minlength="4">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Degree Name</label>
            <input type="text" name="degree${education_count}" class="form-control" maxlength = "50"  minlength="4">
        </div>
        <div class="mb-3 d-flex justify-content-between">
            <div>
                <label for="exampleInputEmail1" class="form-label">From</label>
                <input type="date" name="from${education_count}" class="form-control" maxlength = "50"  minlength="4">
            </div>
            <div>
                <label for="exampleInputEmail1" class="form-label">To</label>
                <input type="date" name="to${education_count}" class="form-control" maxlength = "50"  minlength="4">
            </div>
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Grade/Score/CGPA</label>
            <input type="text" name="grade${education_count}" class="form-control" maxlength = "20"  minlength="1">
        </div>`;
        var htmlObject = document.createElement('div');
        htmlObject.innerHTML=field;
