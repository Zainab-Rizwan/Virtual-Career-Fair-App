...
<?php include "header.php"; ?>
			<form method="POST" enctype = "multipart/form-data" action="code1.php">
				<div class="header">
				...
				<div class="body">
					...
					<div class="col-md-8">
						<div class="form-group">
						  ...
						  <input type="file" name="com_logo" id="com_logo" value="" class="form-control" required="required"/>
						</div>
        ...
        <button type="submit" name="com_update_btn" class="btn btn-primary">update</button>
